...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { abbreviation: @season.abbreviation, description: @season.description, year: @season.year }
    end
  ...
  test "should update season" do
    put :update, id: @season, season: { abbreviation: @season.abbreviation, description: @season.description, year: @season.year }
    assert_redirected_to season_path(assigns(:season))
  end
